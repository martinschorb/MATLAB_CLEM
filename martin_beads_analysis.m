 function [stats] = martin_beads_analysis(pos)

%version MartinSchorb 091221

%usage is martin_beads_analysis(bead coordinates);
%
...
%
%  stats=[numbeads , SD from centre, ellipticity(ratio of the major axis lengths), mean_x,mean_y]
