...
To execute the script and start the correlation simply run \begin{verbatim}
 martin_correlate\end{verbatim} with these optional parameters in brackets \begin{verbatim}(fmf,emf,gmf,rmf,outfileroot)
\end{verbatim}
 in the MATLAB command line.
 \lstinputlisting[linerange={1-35}]{../martin_correlate.m}
The following input parameters can be provided in as command line parameters:
\begin{enumerate}
...
\begin{figure}
 \centering
 \includegraphics[width=.73\textwidth]{images/digitize.jpg}
