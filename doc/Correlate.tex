...
\publishers{\textcolor{blue}{This document can be found in your scripts directory, subfolder \texttt{doc/}}\\ \vspace{2mm} \small{corresponds to commit \git-shash\;commited at \git-shash}\\\small{ of \texttt{martin\_correlate.m} at \url{https://git.embl.de/schorb/corr}
}}
