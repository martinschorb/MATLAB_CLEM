...
You can use the ec-CLEM plugin to register your FM and EM images. However the plugin will perform an on-the-fly transformation of you FM image once you have clicked 3 points. Therefore it will not store the clicked coordinatees in the original FM image. You need to open a the FM image a second time and click the points using "File \& ROI tools" -> "Point". Make sure the order of the points you click here corresponds to the order of points you clicked while using the ec-CLEM plugin. Simply close the EM and FM image to hav Icy store the coordinate files.
