...
\newpage
 \lstinputlisting[linerange={1-75}]{../corr_init_orig.m}
\newpage
...
The fitted positions are presented again using a \texttt{cpselect} dialog.\,(Fig.\,\ref{fig:cpsel_fid1}) To continue, close the window.
 ...
 \lstinputlisting[linerange={157-159,170-171}]{../martin_correlate.m}
...
\lstinputlisting[linerange={291-293,297-298}]{../martin_correlate.m}
