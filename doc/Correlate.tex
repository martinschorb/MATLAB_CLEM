...
\lhead[\thepage]{Correlation procedure for high accuracy CLEM -- \textcopyright~EMBL -- version 2016.1}
\rhead[\leftmark]{\thepage}

\title{High-Accuracy Correlative Microscopy - Algorithm overview}
\author{Martin Schorb, \href{mailto:martin.schorb@embl.de}{martin.schorb@embl.de}}

%\newcommand{\gitshash}{b24aecc}


\publishers{Copyright EMBL 2016}

% \textcolor{blue}{This document can be found in your scripts directory, subfolder \texttt{doc/}}\\ \vspace{2mm} \small{corresponds to commit \gitAbbrevHash\;commited at \gitCommitterIsoDate}\\\small{ of \texttt{martin\_correlate.m} at \url{http://git.embl.de/cgit/schorb/corr/}
% }}
...
\newpage
 \lstinputlisting[linerange={23-85}]{../corr_init_orig.m}
\newpage
...
\end{verbatim}
 ...
 \lstinputlisting[linerange={1-49}]{../martin_correlate.m}
\newpage
...
\lstinputlisting[linerange={1-34}]{../martin_LMtoHM.m}
