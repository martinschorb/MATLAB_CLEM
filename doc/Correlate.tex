...
\pagestyle{fancy}
\fancyhf{}
\lhead[\thepage]{Correlation procedure for CLEM -- commit \git-shash}
...
\publishers{\textcolor{blue}{This document can be found in your scripts directory, subfolder \texttt{doc/}}\\ \vspace{2mm} \small{corresponds to commit xx \;commited at xx }\\\small{ of \texttt{martin\_correlate.m} at \url{https://git.embl.de/schorb/corr}
}}
