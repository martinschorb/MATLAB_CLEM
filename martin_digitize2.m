...
figure(1)
clf
set(gcf,'numberTitle','off','name','Select bleed-through spots to account for shifts')
...
%(a) Pin points
%%%%%%%%%%%%%%%%%%%%%%%%%
[x,map] = imread(fullfile(matlabroot,'toolbox','matlab','icons','pin_icon.gif'));
...
%(b) Zoom tool
%%%%%%%%%%%%%%%%%%%%%%%%%
fname = fullfile(matlabroot,'toolbox','matlab','icons','zoomplus.mat');
