...
loc_pickspots = '/struct/briggs/schorb';%wanda/DataLightMicroscopy';

% Location to search for shift correction coordinate file - *.shiftcoos.mat

loc_shiftcoos = '/struct/briggs/wanda/schorb';%/DataLightMicroscopy';

% Location to search for Highmag Fiducial coordinate file - *.lmhmcoos.mat

loc_hmcoos = '/struct/briggs/schorb';%wanda/DataLightMicroscopy';
